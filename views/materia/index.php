...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Mantenimiento de Materias</h1>
        </div>
        <div class="col-sm-6">
        </div>
      </div>
  ...
  <section class="content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <button id="new_materia" class="btn btn-primary" data-toggle="modal" data-target="#modal_materias">
                <i class="fas fa-plus"></i> Añadir materia</button>
            </div>

            <div class="card-body">
              <table id="table_materia" class="table table-bordered table-hover w-100">
                <thead>
                  <tr>
                    <th>ID</th>
                    <th>Materia</th>
    ...
    <div id="modal_materias" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Formulario de materia</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form method="post" id="form_materias" novalidate>
              ...
              <div class="row">
                ...
                <div class="col-md-12 mt-3 text-right">
                  <button class="btn btn-primary" id="btn_add" type="submit">Guardar materia</button>
                </div>
              </div>
            </form>
          </div>
...
<script src="<?= URL ?>dist/js/pages/materia.js" type="module"></script>
